...
from classification.nets.resnet50 import resnet50
from classification.nets.vgg16 import vgg16
from classification.utils.utils import letterbox_image
...
class Classification(object):
    _defaults = {
        "model_path"    : 'classification/logs/Epoch50-Total_Loss0.0870-Val_Loss0.0343.pth',
